# 1. Import the files
import unittest
from SeleniumFrameworkcloud.tests.test_ContactFormtest import ContactFormTest
from SeleniumFrameworkcloud.tests.test_EnterTextTest import EnterTextTest
