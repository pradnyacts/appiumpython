...
#24 hr format
#logging.basicConfig(format='%(asctime)s: %(levelname)s: %(message)s', datefmt='%d/%m/%y %H:%M:%S %p %A' , level=logging.DEBUG ,filename="test2.log",filemode="a")
# change filemode to w to write and not append
